      ...
      try {
        ...
        try {
          const localReports = JSON.parse(
            localStorage.getItem("citycare_reports") || "[]"
          );
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`${stat.bgColor} rounded-xl flex-shrink-0`}
                    style={{ padding: "16px" }}
                  >
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p
                  ...
                  style={{ marginTop: "4px" }}
                >
                  Latest civic issues reported in your area
                </p>
              </div>
              <button
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    <th
                      className="text-left text-sm font-semibold text-gray-600 uppercase tracking-wider"
                  ...
                  {recentReports.map((report) => (
                    ...
                    >
                      ...
                      <td
                        ...
                        style={{ padding: "20px 32px", maxWidth: "280px" }}
                        title={report.issue}
                      >
                        {report.issue}
                      </td>
                      <td
                        ...
                        style={{ padding: "20px 32px", maxWidth: "320px" }}
                      ...
                      <td style={{ padding: "20px 32px" }}>
                        <span
                          className={`inline-flex items-center gap-1.5 rounded-full text-xs font-semibold whitespace-nowrap ${
